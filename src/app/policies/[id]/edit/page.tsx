  ...
  useEffect(() => {
    if (currentPolicy) {
      ...
      reset({
        ...
        policyEffectiveDate: currentPolicy.policyEffectiveDate,
        policyExpirationDate: currentPolicy.policyExpirationDate,
        policyHolder: currentPolicy.policyHolder,
        drivers: currentPolicy.drivers,
        vehicles: currentPolicy.vehicles,
      });
    }
  }, [currentPolicy, reset]);
        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="mb-6">
            ...
            <h1 className="text-3xl font-bold leading-tight text-gray-900">
              Edit Policy {currentPolicy.policyNo}
            </h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Update basic policy details and dates</CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Update policy holder details</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>Update drivers covered under this policy</CardDescription>
                  </div>
                  <Button
                    type="button"
                    variant="outline"
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>Update vehicles covered under this policy</CardDescription>
                  </div>
                  <Button
                    type="button"
                    variant="outline"
